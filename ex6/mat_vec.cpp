...
int main (int argc, char** argv)
{
	...
	if (rank == 0)
	{
		...
		//TODO : calculate rows, start_row for each processor, fill in appropriate values in displ and recv_count and then send rows, start_row and the actual row block to each processor
	...
	{   
		...
		//TODO: receive rows and start_row from master processor
		A = new double[rows*N];
		//TODO: receive the block rows in A
	...
	//TODO: Calculate part of resultant vector 
